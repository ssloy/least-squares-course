...
The addition and multiplication operations are defined over matrices, just as over numbers. The division is a bit more complicated, but in certain cases it can be defined too.
