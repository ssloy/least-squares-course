...
u(t) = -F v(t),
$$
This gain is necessary to build a closed-loop regulator, it can be computed from $J$.
...
This method works not in the original space, but in the space transformed by some linear operator $M$, and directly projects the solution on an orthogonal basis.
